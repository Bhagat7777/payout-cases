  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#0B0F17" }}>
      ...
      >
        ...
        <p className="text-gray-400 mb-6">Welcome back — sign in to submit cases and manage your account.</p>
        ...
        <div className="mt-4 text-sm text-gray-400">
          Don't have an account? <Link href="/auth/register" className="text-[#00D1B2] hover:underline">Create one</Link>
        </div>
      </motion.div>
    </div>
  )
